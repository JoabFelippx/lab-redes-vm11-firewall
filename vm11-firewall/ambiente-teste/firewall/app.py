...
LDAP_SERVER   = os.environ.get("LDAP_SERVER",  "ldap://10.10.0.86:389")
...
VLANS = {
    "MGMT":    {"subnet": "172.16.10.0/24", "vlan": 10, "cor": "#3b82f6"},
    "SERVER":  {"subnet": "172.16.20.0/24", "vlan": 20, "cor": "#10b981"},
    "DMZ":     {"subnet": "172.16.30.0/24", "vlan": 30, "cor": "#f59e0b"},
    "MONITOR": {"subnet": "172.16.40.0/24", "vlan": 40, "cor": "#8b5cf6"},
    "NETDEV":  {"subnet": "172.16.50.0/24", "vlan": 50, "cor": "#ec4899"},
    "USERS":   {"subnet": "172.16.60.0/24", "vlan": 60, "cor": "#06b6d4"},
}
